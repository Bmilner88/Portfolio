            ...
            <div className='container'>
                ...
                <div className='card m-5 col'>
                        <div className='card-body'>
                            ...
                            <img id='regal' src={require(`../assets/images/regal.png`)} alt='Regal' className='card-img'/>
                ...
                <div className='card m-5 col'>
                        <div className='card-body'>
                            ...
                            <img id='budgetek' src={require(`../assets/images//budgetek.png`)} alt='ShowPro' className='card-img'/>
                    ...
                    <div className='card m-5 col'>
                        <div className='card-body'>
                            ...
                            <img id='showpro' src={require(`../assets/images/showpro.png`)} alt='ShowPro' className='card-img'/>
                ...
                <div className='row bottom-cards'>
                    <div className='card m-5 col'>
                        <div className='card-body'>
                            ...
                            <img id='sfcc-xml' src={require(`../assets/images/sfcc-xml.png`)} alt='SFCC Customer Group XML Gen' className='card-img'/>
                    ...
                    <div className='project card m-5 col'>
                        <div className='card-body'>
                            ...
                            <img id='code=quiz' src={require(`../assets/images/code-quiz.png`)} alt='Code Quiz' className='card-img-top'/>
                    ...
                    <div className='project card m-5 col'>
                        <div className='card-body'>
                            ...
                            <img id='weather-dashboard' src={require(`../assets/images/weather-dashboard.png`)} alt='Weather Dashboard' className='card-img'/>
